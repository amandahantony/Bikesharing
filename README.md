...
2) We can also look at where each age group starts their rides by graphing birth year and start location. For example, of the riders who start their trip around Pershing Square, are most of them young, middle-aged etc. Based on this we can make age appropriate accomodations, advertising etc. 
